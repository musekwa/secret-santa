...
export default class GroupServices {
  ...
  static async create(name: string, owner_id: string) {
    try {
      ...
      const messageGroup =
        "Grupo criado com sucesso e o dono foi adicionado como o primeiro participante";
  ...
  static async findMany(id?: string) {
    try {
      ...
      return {
        success: false,
        data: [],
        message: `Erro ao buscar os grupos: ${error}`,
      };
    }
  }
  ...
  static async findById(id: string) {
    try {
      ...
      return {
        success: false,
        data: [],
        message: `Erro ao buscar o grupo: ${error}`,
      };
    }
  }
